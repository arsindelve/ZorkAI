...
/// <summary>
/// A "side by side" twin of <see cref="WalkthroughTestOne"/> (the full Planetfall win) that travels by
/// NAMING ROOMS — and, where the sweep gave them, by colloquial SYNONYMS ("go to the galley", "go to
/// the cafeteria", "go to the workshop", "go to the foyer", "go to navigation", "go to kalamontee
/// station") — instead of cardinal directions, to exercise issue #268 destination navigation across a
/// real Planetfall playthrough.
///
/// Cardinal directions remain where naming genuinely cannot apply: the escape-pod launch, the ladder
/// rift crossing, the gated elevator-car boardings, the shuttle ride, the two unnamed comm-hole spots
/// in the Tower, the teleport-booth hopping, and the timed mutant-chase finale. The corridor clusters
/// (Mech / Admin / Systems / Project) are named in full ("go to mech corridor north") because the bare
/// "mech corridor" is a sub-phrase of its siblings.
/// </summary>
[TestFixture]
public sealed class WalkthroughByLocationName : WalkthroughTestBase
{
    ...
    [TestCase("go to the cliff", null, "Crag")]
    [TestCase("score", null, "would be 6")]
    [TestCase("go to the terrace", null, "Balcony")]
    [TestCase("go to the staircase", null, "Winding Stair")]
    [TestCase("go to the ruins", null, "Courtyard")]
    [TestCase("go to the plain hall", null, "Plain Hall")]
    [TestCase("go to the rec corridor", null, "Rec Corridor")]
    [TestCase("go to the mess corridor", null, "Mess Corridor")]
    [TestCase("go to the dorm corridor", null, "Dorm Corridor")]
    [TestCase("go to the corridor junction", null, "Corridor Junction")]
    [TestCase("go to mech corridor north", null, "Mech Corridor North")]
    [TestCase("go to mech corridor", null, "Mech Corridor")]
    [TestCase("go to reactor control", null, "Reactor Control")]
    [TestCase("go to the reactor elevator", null, "Reactor Elevator", "an Up button, a Down button, and a small slot")]
    [TestCase("press up button", null, "Nothing happens")]
    [TestCase("examine slot", null, "small slot")]
    [TestCase("go to reactor control", null, "Reactor Control")]
    [TestCase("go to mech corridor", null, "Mech Corridor")]
    [TestCase("go to mech corridor south", null, "Mech Corridor South")]
    [TestCase("go to the toolroom", null, "Tool Room")]
    [TestCase("take magnet", null, "Taken")]
    [TestCase("go to the workshop", null, "Machine Shop")]
    [TestCase("go to the robot shop", null, "Robot Shop")]
    ...
    [TestCase("go to mech corridor north", null, "Mech Corridor North")]
    [TestCase("go to the corridor junction", null, "Corridor Junction")]
    [TestCase("go to admin corridor south", null, "Admin Corridor South")]
    ...
    [TestCase("go to the supply room", null, "Storage West")]
    [TestCase("score", null, "would be 12")]
    [TestCase("drop all", null, "Dropped")]
    [TestCase("take ladder", null, "Taken")]
    [TestCase("go to the mess corridor", null, "Mess")]
    [TestCase("go to the dorm corridor", null, "Dorm")]
    [TestCase("go to the corridor junction", null, "Junction", "Finally, you see an intersection")]
    ...
    [TestCase("go to the small office", null, "Small Office")]
    ...
    [TestCase("go to the large office", null, "Large Office")]
    ...
    [TestCase("go to the small office", null, "Small Office")]
    [TestCase("go to admin corridor north", null, "Admin", "North")]
    [TestCase("S", null, "Admin", "slowly make your way across the swaying")]
    [TestCase("S", null, "South")]
    [TestCase("go to the corridor junction", null, "Junction")]
    [TestCase("go to the dorm corridor", null, "Dorm", "Finally, you see an intersection")]
    [TestCase("go to the mess corridor", null, "Mess Corridor")]
    [TestCase("go to the cafeteria", null, "Mess Hall")]
    ...
    [TestCase("go to mech corridor north", null, "Mech Corridor North")]
    [TestCase("go to the corridor junction", null, "Corridor Junction")]
    [TestCase("go to the elevator lobby", null, "Elevator Lobby")]
    ...
    [TestCase("go to the tower core", null, "Tower Core")]
    ...
    [TestCase("wait", null, "passes")]
    [TestCase("wait", null, "slides open")]
    [TestCase("go to the waiting room", null, "Waiting Area")]
    [TestCase("go to kalamontee station", null, "Kalamontee Platform")]
    ...
    [TestCase("go to the escalator", null, "Escalator")]
    [TestCase("go to the fork", null, "Fork")]
    [TestCase("go to systems corridor west", null, "Systems Corridor West")]
    [TestCase("go to the workshop", null, "Repair Room")]
    [TestCase("floyd, go north", null, "Just a shiny fromitz board")]
    [TestCase("floyd, take board", null, "If you say so")]
    [TestCase("go to systems corridor west", null, "Systems Corridor West")]
    [TestCase("go to systems corridor", null, "Systems Corridor")]
    [TestCase("go to planetary defense", null, "Planetary Defense")]
    ...
    [TestCase("go to systems corridor", null, "Systems Corridor")]
    [TestCase("go to systems corridor east", null, "Systems Corridor East")]
    [TestCase("go to navigation", null, "Course Control")]
    [TestCase("open cube", null, "The lid swings open", "fused")]
    [TestCase("take bedistor", null, "fused to its socket")]
    [TestCase("go to systems corridor east", null, "Systems Corridor East")]
    [TestCase("go to the foyer", null, "Library Lobby")]
    [TestCase("activate terminal", null, "The screen gives off a green flash", "1. Histooree")]
    [TestCase("key 4 on the terminal", null, "0. Maan Menyuu", "1. Planit Landmasiz")]
    [TestCase("press 0 on the terminal", null, "1. Histooree")]
    [TestCase("type 6", null, "1. Zoork")]
    [TestCase("type 1", null, "adventshur klasik")]
    [TestCase("type 0", null, "1. Zoork")]
    [TestCase("type 0", null, "1. Histooree")]
    [TestCase("deactivate terminal", null, "The screen goes dark")]
    [TestCase("go to project corridor east", null, "Project Corridor East")]
    [TestCase("go to the main lab", null, "Main Lab")]
    [TestCase("go to the storeroom", null, "Lab Storage")]
    ...
    [TestCase("S", null, "Middle of Strip", "giant elephant-sized monster lands on the strip")]
    // The microbe blocks the way out — heat the laser up and sacrifice it to lure the microbe off the strip.
    [TestCase("set laser to 2", null, "The dial is now set to 2.")]
    [TestCase("shoot microbe with laser", null, "The laser beam strikes the microbe")]
    [TestCase("shoot microbe with laser", null, "The laser beam strikes the microbe")]
    [TestCase("shoot microbe with laser", null, "The laser beam strikes the microbe")]
    [TestCase("shoot microbe with laser", null, "The laser beam strikes the microbe")]
    [TestCase("shoot microbe with laser", null, "The laser beam strikes the microbe")]
    ...
    [TestCase("shoot microbe with laser", null, "The laser beam strikes the microbe")]
    [TestCase("shoot microbe with laser", null, "The laser beam strikes the microbe")]
    [TestCase("throw laser off strip", null, "Both the laser and the microbe plummet into the void")]
