...
public sealed class WalkthroughTestOne : WalkthroughTestBase
{
    ...
    //[TestCase("wait", null, "More powerful explosions buffet the ship.")]
    // [TestCase("wait", null, "Explosions continue ")]
    // [TestCase("wait", null, "You feel the pod begin")]
    // [TestCase("wait", null, "Through the viewport of the pod")]
