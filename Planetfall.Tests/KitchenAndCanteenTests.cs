...
public class KitchenAndCanteenTests : EngineTestsBase
{
    ...
    public async Task PutCanteenInMachine()
    {
        ...
        response.Should().Contain("The canteen fits snugly into the octagonal niche, its mouth resting just below the spout of the machine");
    ...
    public async Task PressButton_MachineEmpty()
    {
        ...
        response.Should().Contain("A thick, brownish liquid pours from the spout and splashes to the floor, where it quickly evaporates");
    }
    ...
    public async Task PressButton_Full_NoUniform()
    {
        ...
        var response = await target.GetResponse("press button");
        response.Should().Contain("The brown liquid splashes over the mouth of the already-filled canteen, creating a mess");
