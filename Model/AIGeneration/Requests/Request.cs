...
public abstract class Request
{
    ...
    protected static readonly string SystemPrompt =
        "In your role as the Narrator within a fantasy interactive fiction game, you must delivering engaging " +
        "responses of one to three sentences that do not progress the story. While maintaining a very humorous " +
