...
public interface ICanBeAttacked
{
    ...
    /// GodModeProcessor.Kill). Returns true if this creature supports being killed this way; the
    /// default (false) leaves the creature untouched, so unsupported creatures fall through to the
    /// generic god-mode error message.
    /// </summary>
    bool GodModeKill() => false;
}