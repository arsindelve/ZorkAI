...
namespace EscapeRoom_Lambda.Controllers;

[ApiController]
[Route("[controller]")]
public class EscapeRoomController(
    ILogger<EscapeRoomController> logger,
    IGameEngine engine,
    ...
    : ControllerBase
{
    private const string SaveGameTableName = "escaperoom_savegame";
    private const string SessionTableName = "escaperoom_session";
