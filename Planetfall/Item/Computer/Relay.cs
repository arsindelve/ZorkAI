        ...
        get
        {
            ...
            if (SpeckDestroyed)
                return "This is a vacuum-sealed microrelay, encased in red translucent plastic. " +
                       "The relay is now slowly closing, having been cleared of the obstruction. ";

            if (SpeckHit)
                return "This is a vacuum-sealed microrelay, encased in red translucent plastic. Within, you can see " +
                       "a blue speck that has been partially damaged by a laser beam. It looks like one more hit would destroy it. ";
