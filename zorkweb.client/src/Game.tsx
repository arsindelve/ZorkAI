...
function Game() {
    ...
    return (
        <div className={'relative flex flex-col flex-1 min-h-0 mx-10 mt-[39px] mb-8'}>
            ...
            <div className="flex flex-col items-stretch gap-2 bg-gradient-to-r from-stone-800 to-stone-700 px-3 sm:px-5 py-3 min-h-[90px] rounded-b-lg border-x-2 border-b-2 border-t border-stone-700/50 shadow-inner">
