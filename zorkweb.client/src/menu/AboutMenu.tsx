    ...
    return (
        <div>
            ...
            >
                ...
                <MenuItem
                    onClick={() =>
                        go('1984 Manual', 'https://infodoc.plover.net/manuals/zork1.pdf')
                    }
                >
                    <ListItemIcon>
                ...
                <MenuItem
                    onClick={() =>
                        go('1982 Manual', 'https://www.mocagh.org/infocom/zorkps-manual.pdf')
                    }
                >
                    <ListItemIcon>
                        <MenuBookIcon fontSize="small" />
                ...
                <MenuItem
                    onClick={() => go('Map', 'https://www.mocagh.org/infocom/zork-map-front.pdf')}
                >
                    <ListItemIcon>
                ...
                <MenuItem
                    onClick={() =>
                        go(
                            'Play Original',
                            'https://iplayif.com/?story=https%3A%2F%2Feblong.com%2Finfocom%2Fgamefiles%2Fzork1-r119-s880429.z3',
                        )
                    }
                >
                    <ListItemIcon>
