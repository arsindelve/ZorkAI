...
describe('ReleaseNotesModal Component', () => {
  ...
  test('renders nothing when open is false', () => {
    render(<ReleaseNotesModal open={false} handleClose={mockHandleClose} releases={mockReleases} gameName="Zork AI" />);
  ...
  test('renders dialog when open is true', () => {
    render(<ReleaseNotesModal open={true} handleClose={mockHandleClose} releases={mockReleases} gameName="Zork AI" />);
  ...
  test('shows loading skeletons when releases array is empty', () => {
    render(<ReleaseNotesModal open={true} handleClose={mockHandleClose} releases={[]} gameName="Zork AI" />);
