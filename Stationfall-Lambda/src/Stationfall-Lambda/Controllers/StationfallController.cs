...
namespace Stationfall_Lambda.Controllers;

[ApiController]
[Route("[controller]")]
public class StationfallController(
    ILogger<StationfallController> logger,
    IGameEngine engine,
    ...
    : ControllerBase
{
    private const string SaveGameTableName = "stationfall_savegame";

    // Must match StationfallGame.SessionTableName — the engine and this controller both name the table.
