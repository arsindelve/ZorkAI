...
| **Zork I** | [01 structure & DAG](zorkone/01-structure-dag.md) · [02 state audit](zorkone/02-state-audit.md) · [03 soft-locks](zorkone/03-softlock.md) · [04 eval](zorkone/04-eval.md) · [05 lore source](zorkone/05-lore.md) |
