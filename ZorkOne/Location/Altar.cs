...
public class Altar : LocationBase, IThiefMayVisit
{
    ...
    protected override Dictionary<Direction, MovementParameters> Map(IContext context)
    {
        return new Dictionary<Direction, MovementParameters>
        {
            { Direction.N, new MovementParameters { Location = GetLocation<Temple>() } },
            {
                ...
                {
                    WeightLimit = 15,
                    WeightLimitFailureMessage =
                        "You haven't a prayer of getting down there with what you're carrying. ",
    ...
    {
        return "This is the south end of a large temple. In front of you is what appears to be an altar. " +
               "In one corner is a small hole in the floor which leads into darkness. You probably could not get back up it. ";
    }

    public override async Task<InteractionResult> RespondToSpecificLocationInteraction(string? action, IContext context,
